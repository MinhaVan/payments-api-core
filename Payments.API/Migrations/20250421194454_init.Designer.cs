...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Payments.Domain.Models.AjusteAlunoRota", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Payments.Domain.Models.Aluno", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Payments.Domain.Models.AlunoRota", b =>
                {
                    b.Property<int>("AlunoId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Payments.Domain.Models.AlunoRotaHistorico", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Payments.Domain.Models.Empresa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Payments.Domain.Models.Endereco", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Payments.Domain.Models.LocalizacaoTrajeto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Payments.Domain.Models.Motorista", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Payments.Domain.Models.MotoristaRota", b =>
                {
            ...
            modelBuilder.Entity("Payments.Domain.Models.OrdemTrajeto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Payments.Domain.Models.OrdemTrajetoMarcador", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Payments.Domain.Models.Permissao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Payments.Domain.Models.Rota", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Payments.Domain.Models.RotaHistorico", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Payments.Domain.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Payments.Domain.Models.UsuarioPermissao", b =>
                {
                    b.Property<int>("UsuarioId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Payments.Domain.Models.Veiculo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Payments.Domain.Models.AjusteAlunoRota", b =>
                {
                    b.HasOne("Payments.Domain.Models.Endereco", "EnderecoDestino")
                        .WithMany("AjusteAlunoRotasDestino")
                        .HasForeignKey("NovoEnderecoDestinoId");

                    b.HasOne("Payments.Domain.Models.Endereco", "EnderecoPartida")
                        .WithMany("AjusteAlunoRotasPartida")
                        .HasForeignKey("NovoEnderecoPartidaId");

                    b.HasOne("Payments.Domain.Models.Endereco", "EnderecoRetorno")
                        .WithMany("AjusteAlunoRotasRetorno")
                        .HasForeignKey("NovoEnderecoRetornoId");

                    b.HasOne("Payments.Domain.Models.AlunoRota", null)
            ...
            modelBuilder.Entity("Payments.Domain.Models.Aluno", b =>
                {
                    b.HasOne("Payments.Domain.Models.Empresa", "Empresa")
                        .WithMany("Alunos")
                    ...
                    b.HasOne("Payments.Domain.Models.Usuario", "Responsavel")
                        .WithMany("Alunos")
            ...
            modelBuilder.Entity("Payments.Domain.Models.AlunoRota", b =>
                {
                    b.HasOne("Payments.Domain.Models.Aluno", "Aluno")
                        .WithMany("AlunoRotas")
                        .HasForeignKey("AlunoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Payments.Domain.Models.Rota", "Rota")
                        .WithMany("AlunoRotas")
            ...
            modelBuilder.Entity("Payments.Domain.Models.AlunoRotaHistorico", b =>
                {
                    ...
                    b.HasOne("Payments.Domain.Models.RotaHistorico", "RotaHistorico")
            ...
            modelBuilder.Entity("Payments.Domain.Models.Assinatura", b =>
                {
                    ...
                    b.HasOne("Payments.Domain.Models.Usuario", "Usuario")
                        .WithMany("Assinaturas")
            ...
            modelBuilder.Entity("Payments.Domain.Models.Motorista", b =>
                {
                    b.HasOne("Payments.Domain.Models.Usuario", "Usuario")
                        .WithOne("Motorista")
                        .HasForeignKey("Payments.Domain.Models.Motorista", "UsuarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Payments.Domain.Models.MotoristaRota", b =>
                {
                    b.HasOne("Payments.Domain.Models.Motorista", "Motorista")
            ...
            modelBuilder.Entity("Payments.Domain.Models.OrdemTrajeto", b =>
                {
                    b.HasOne("Payments.Domain.Models.Aluno", null)
            ...
            modelBuilder.Entity("Payments.Domain.Models.OrdemTrajetoMarcador", b =>
                {
                    b.HasOne("Payments.Domain.Models.OrdemTrajeto", "OrdemTrajeto")
                        .WithMany("Marcadores")
            ...
            modelBuilder.Entity("Payments.Domain.Models.Rota", b =>
                {
                    ...
                    b.HasOne("Payments.Domain.Models.Endereco", null)
                        .WithMany("Rotas")
                        .HasForeignKey("EnderecoId");

                    b.HasOne("Payments.Domain.Models.Veiculo", "Veiculo")
                        .WithMany("Rotas")
            ...
            modelBuilder.Entity("Payments.Domain.Models.Usuario", b =>
                {
                    ...
                    b.HasOne("Payments.Domain.Models.Endereco", "EnderecoPrincipal")
                        .WithMany()
            ...
            modelBuilder.Entity("Payments.Domain.Models.UsuarioPermissao", b =>
                {
                    b.HasOne("Payments.Domain.Models.Permissao", "Permissao")
                        .WithMany("Usuarios")
