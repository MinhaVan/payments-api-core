...
public class MotoristaService : IMotoristaService
{
    ...
    public async Task<MotoristaViewModel> AdicionarAsync(MotoristaNovoViewModel usuarioNovoViewModel)
    {
        ...
        var response = await _usuarioService.Registrar(_mapper.Map<UsuarioNovoViewModel>(usuarioNovoViewModel));

        var model = _mapper.Map<Motorista>(usuarioNovoViewModel);
        model.UsuarioId = response.Id;
    ...
    {
        await _usuarioService.Atualizar(usuarioAtualizarViewModel);
